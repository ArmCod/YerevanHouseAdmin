      ...
      >
        ...
        >
          <FormControlLabel
            ...
            name="house"
            checked={`${data?.house}`.toLowerCase() === "house".toLowerCase()}
            onChange={(e) => handleChangeCheck(e)}
          />
        </div>) : (
          <div
        ...
        >
          <FormControlLabel
            ...
            name="townhouse"
            checked={`${data?.townhouse}`.toLowerCase() === "townhouse".toLowerCase()}
            onChange={(e) => handleChangeCheck(e)}
          />
        </div>) : (
          <div
        ...
        >
          ...
          <FormControlLabel
            ...
            name="country_house"
            checked={`${data?.country_house}`.toLowerCase() === "country house".toLowerCase()}
                ...
                <>
                  ...
                  >
                    <FormControlLabel
                      control={<Checkbox />}
                      label={
                        <span style={{ fontSize: 13 }}>Միջոցառումներ</span>
                      }
                      name="event"
                      checked={

...
const MinMax = ({ type, filter, handleChange }) => {
	...
	<div style={{ display: 'flex', marginTop: 20, gap: 20 }}>
            <Box>
                <h5 style={{ margin: '3px 0', color: 'white', backgroundColor: 'black', padding: '5px 5px' }}>Մին․ ընդհանուր մակերես</h5>
                <TextField
                    name="min_lead_area"
                    fullWidth
                    value={filter.min_lead_area}
                    onChange={handleChange}
                    placeholder="Մին․ընդհանուր մակերես"
                    size="small"
                />
            </Box>
            <Box>
                <h5 style={{ margin: '3px 0', color: 'white', backgroundColor: 'black', padding: '5px 5px' }}>Մաքս․ ընդհանուր մակերես</h5>
                <TextField
                    name="max_lead_area"
                    fullWidth
                    value={filter.max_lead_area}
                    onChange={handleChange}
                    placeholder="Մաքս․ընդհանուր մակերես"
                    size="small"
                />
            </Box>
        </div>

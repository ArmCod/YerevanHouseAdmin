    ...
    return (
        <Box>
            ...
            <div style={{ border: '1px solid black', padding: '10px', borderRadius: 10 }}>
                ...
                <Box>
                    <h3 style={{ margin: '10px 0 2px 2px', fontSize: 14 }}>Սեփականատիրոջ Հեռախոսահամարը</h3>
                ...
                <Box>
                    ...
                    <TextareaAutosize
                        ...
                        style={{ width: '95%', height: 130, padding: '15px 10px', lineHeight: '20px', fontSize: '15px', overflowY: 'auto' }}
                        className="staxko"
                        value={data.notes}
                        onChange={handleChange}
                    />
                ...
                {/* <Box>
                    <h3 style={{ margin: '10px 0 0 2px', fontSize: 14 }}>Ներքին կոդ </h3>
                    <TextField
                        name="inner_code"
                        fullWidth

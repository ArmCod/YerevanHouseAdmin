...
const Radios = () => {
    return (
        <>
            <FormControl>
                <FormLabel id="demo-radio-buttons-group-label">Շինության տիպ</FormLabel>
                <RadioGroup
                ...
                >
                    <div styler={{ display: 'flex' }}>
                        ...
                        <FormControlLabel value="stone" name="stone" control={<Radio />} label="Քարե" />
            ...
            <FormControl>
                ...
                >
                    <div styler={{ display: 'flex' }}>
                        ...
                        <FormControlLabel value="Lets_draw" name="lets_draw" control={<Radio />} label="Դիզայներական" />

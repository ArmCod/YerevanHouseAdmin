...
import { LandmarkPost } from '../../store/actions/landmarkAction';
...
const LandmarkAddModal = ({ openAdd, setOpenAdd }) => {
...
export default LandmarkAddModal;